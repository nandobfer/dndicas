  ...
  const fetchCompanies = async () => {
    ...
    try {
      const response = await api.get<PaginatedResponse<Company>>(
        `/companies?page=${page}&limit=10&search=${search}`
      );
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          ...
          <ul className="list-disc list-inside ml-4">
            <li><code className="bg-muted px-1 rounded">GET /api/companies</code> - Lista empresas</li>
            <li><code className="bg-muted px-1 rounded">POST /api/companies</code> - Cria empresa</li>
            <li><code className="bg-muted px-1 rounded">GET /api/companies/[id]</code> - Busca por ID</li>
            <li><code className="bg-muted px-1 rounded">PUT /api/companies/[id]</code> - Atualiza</li>
            <li><code className="bg-muted px-1 rounded">DELETE /api/companies/[id]</code> - Exclui</li>
          </ul>
          <p>
            Use este exemplo como referência para criar seus próprios módulos.
          </p>
        </CardContent>
      </Card>
    </div>
