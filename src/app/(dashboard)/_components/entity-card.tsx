...
export function EntityCard({
    ...
    return (
        <motion.div
            ...
            className="h-full"
        >
            <Link href={href || "#"} className={cn("block h-full outline-none", !href && "pointer-events-none")}>
                <GlassCard
                    className={cn("h-[212px] group transition-all relative overflow-hidden flex flex-col", config.border, !isLoading && config.hoverBorder, href && !isLoading && "cursor-pointer")}
                    style={{
                ...
                >
                    ...
                    <div className="absolute inset-0 z-0 pointer-events-none">
                        <div className="absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-500" style={{ backgroundColor: config.hex }} />
                        <div
                            className="absolute top-0 right-0 w-32 h-32 blur-3xl rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-500"
                            style={{ backgroundColor: config.hex }}
                        />
                    </div>
