    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Demonstração do serviço de envio de emails (Nodemailer)
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <Button
            ...
            onClick={() =>
              setHtml(
                '<h1 style="color: #22c55e;">Bem-vindo!</h1><p>Este é um email de boas-vindas.</p>'
              )
            }
          >
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            Este exemplo demonstra o uso do serviço de email centralizado.
          </p>
          <p>
          ...
          <p className="text-xs">
            Se o SMTP não estiver configurado, o email será "mockado" (apenas log no console).
          </p>
        </CardContent>
      </Card>
    </div>
