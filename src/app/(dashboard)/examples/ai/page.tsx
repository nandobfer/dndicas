    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Demonstração do serviço de IA (Google Gemini)
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm text-muted-foreground">
          <p>
            Este exemplo demonstra o uso do serviço de IA centralizado do core.
          </p>
          <p>
          ...
          <p>
            Todos os usos são automaticamente registrados no banco de dados para controle de consumo.
          </p>
        </CardContent>
      </Card>
    </div>
