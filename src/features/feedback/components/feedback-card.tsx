...
import { Calendar, User as UserIcon, Bug, Sparkles, AlertCircle, CheckCircle2, XCircle } from "lucide-react"
    ...
    return (
        <div className="space-y-4 w-full relative">
                ...
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1 space-y-1.5">
                        <div className="flex flex-wrap items-center gap-2">
                            <Link href={`/feedback/${feedback.id}`} className="text-sm font-bold leading-tight text-white transition-colors hover:text-blue-200 hover:underline hover:underline-offset-4">
                                {feedback.title}
                            </Link>
                        </div>
                        <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="space-y-2 pb-2 border-b border-white/5">
                <p className="line-clamp-3 text-xs leading-relaxed text-white/70">{stripHtml(feedback.description) || "Sem descrição."}</p>
