        ...
        <div className="space-y-5 w-full text-left">
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                    <div className={cn("p-1.5 rounded-lg border", entityColors.Monstro.badge, entityColors.Monstro.border)}>
                ...
                <div className="flex items-center gap-2">
                    {!hideActionIcons && (
                        <motion.button
                            ...
                            whileTap={{ scale: 0.9 }}
                            onClick={() => addWindow({ title: monster.name || "Monstro", content: null, item: monster, entityType: "Monstro" })}
